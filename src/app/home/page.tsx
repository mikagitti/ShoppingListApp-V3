...
import { GetAllUsers, UpdateUserName } from "../../Database/dbConnectionV3";
...
export default function Home() {
     ...
     const getAllUsersFromV3 = async () => {
          ...
          if (returnUsers !== null) {
               let tempUsers = returnUsers.map((x) => ({
                    id: x.id,
                    name: x.name,
               }));
     ...
     const userFieldToEdit = () => {
          return (
               ...
               >
                    ...
                    />
                    <Button sx={{}} onClick={() => handleUpdate()}>
                         Update User
                    </Button>
               </Box>
          );
     ...
     return (
          ...
          >
               <Typography variant="h3">Take note!!!</Typography>
               ...
               <Box sx={{ mt: "20px" }}>{userId && userFieldToEdit()}</Box>
          </Box>
     );
}
