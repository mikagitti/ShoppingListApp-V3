...
import { RemoveShoppingList, ShoppingListType } from '@/Database/dbConnectionV2';
  ...
  return (
    <div style={ modalStyle }>      
      <Box sx={backgroundStyle}>
        ...
        <Typography variant='h4'sx={ {my: '20px'} } color={'secondary.dark'}>{shoppingList.name}</Typography>
