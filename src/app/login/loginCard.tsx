...
import { UpdateUserName, UserType } from '@/Database/dbConnectionV2';
    ...
    return (
        ...
        :               
            <Box sx={boxStyle}>
                ...
                <Box>                        
                    <IconButton onClick={() => setOpenUpdate(!openUpdate)} color="primary" >                        
                        <EditIcon />                        
                    </IconButton>                        
                </Box>           
                ...
                <Box>
                    <CustomLink href="/shoppinglist_v2">
                        <CustomButton  onClick={() => clickSelect(user)}>
                            Log me in
                        </CustomButton>
                    </CustomLink>
                </Box>                    
